...
import { Sun, Sunset, Moon, MapPin, Clock, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col items-center text-center mb-10 relative">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-xl font-bold px-8 py-2 rounded-full shadow-lg shadow-indigo-500/30 mb-5 transform hover:scale-105 transition-transform">
            Day {day.dayNumber}
        </div>
