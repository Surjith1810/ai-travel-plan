    ...
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 animate-fade-in-up">
        <div className="flex justify-center">
          <div className="bg-white/20 backdrop-blur-md p-5 rounded-3xl shadow-2xl border border-white/30 animate-float hover:rotate-0 transition-transform duration-500">
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white/90 backdrop-blur-xl text-slate-500 rounded-full">
                  Or continue with
                </span>
              </div>
            </div>
